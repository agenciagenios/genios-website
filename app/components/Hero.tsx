  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container px-6 mx-auto text-center z-10">
        ...
        >
          <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium text-blue-400 bg-blue-500/10 rounded-full border border-blue-500/20 backdrop-blur-sm">
            Transformando ideias em inovações
          </span>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tighter text-white mb-6">
            Agência <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Gênios</span>
          </h1>
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <a
              href="#contato"
              className="px-8 py-4 text-lg font-medium text-white bg-[#0071e3] rounded-full hover:bg-[#0077ED] transition-all shadow-[0_0_20px_rgba(0,113,227,0.4)] hover:shadow-[0_0_30px_rgba(0,113,227,0.6)]"
            >
              Começar Projeto
            </a>
            <a
