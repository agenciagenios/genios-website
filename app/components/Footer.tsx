      ...
      <div className="container px-6 mx-auto">
        <div className="flex flex-col md:flex-row justify-between gap-10 mb-16">
          <div className="md:w-1/3">
             <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-orange-500 mb-4">Agência Gênios</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-10">
            <div>
              ...
              <ul className="space-y-2 text-sm text-zinc-500">
                ...
                <li><a href="#portfolio" className="hover:text-yellow-400 transition-colors">Portfólio</a></li>
        ...
        <div className="border-t border-white/5 pt-10 mt-10">
           <p className="text-[10px] text-zinc-800 text-justify leading-tight">
             A Agência Gênios é sua parceira ideal para Criação de Sites, Desenvolvimento de Aplicativos, Design de Marcas, Identidade Visual em todo Brasil. 
             ...
             Se você busca uma agência de publicidade moderna, design minimalista e alta conversão, somos a escolha certa. 
